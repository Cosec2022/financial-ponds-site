...
| --- | --- | ---: | --- | --- |
| 1 | A-share Healthcare and Pharma Pool | 32 | 数据非真实，禁止指导 | non_real_flow_source, valuation_manual_seed, fundamental_manual_seed |
...
| 4 | A-share Communication and Electronics Pool | 32 | 数据非真实，禁止指导 | non_real_flow_source, valuation_manual_seed, fundamental_manual_seed |
...
| 9 | A-share Resources and Materials Pool | 32 | 数据非真实，禁止指导 | non_real_flow_source, valuation_manual_seed, fundamental_manual_seed |
