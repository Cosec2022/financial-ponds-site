...
|---|---:|---|---|
| FP-GATE-01 Decision Gate Ledger | 25% | critical_path | Clear valuation/fundamental, data reality, conflict-review, and execution-language blockers |
