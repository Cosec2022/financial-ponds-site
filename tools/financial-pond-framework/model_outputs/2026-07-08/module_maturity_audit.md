...
- as_of: 2026-07-08
- average_progress: 44.26%
- decision_path_progress: 50.8%
- low_maturity_count: 8
...
|---|---:|---|---|
| FP-WATCH-01 Watchlist State Machine | 30% | critical_path | Add persistence-aware unchanged/upgraded/downgraded behavior after more daily samples |
